 ...
 */
       ...
       strcpy(tag[nt], "BoxLimit");
       addr[nt] = &All.BoxLimit;
       id[nt++] = REAL;
 #endif /* #ifdef NODEREFINE_BACKGROUND_GRID */

 #ifdef METALLIC_COOLING
       strcpy(tag[nt], "InitBackgroundMetallicity");
       addr[nt] = &All.InitBackgroundMetallicity;
       id[nt++] = REAL;         
 
       strcpy(tag[nt], "InitDiskMetallicity");
       addr[nt] = &All.InitDiskMetallicity;
       id[nt++] = REAL;         

       strcpy(tag[nt], "disk_density");
       addr[nt] = &All.disk_density;
       id[nt++] = REAL;         
 #endif
